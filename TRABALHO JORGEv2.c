...
void excluimonomio(pExpressao *p){
pExpressao aux= *p;
if (aux){
    if (aux->ant==NULL){
        *p=aux->prox;
...
int main(){
char s[TAM_POLINOMIO]="2xxxx+0y+42zz^0yy^0x^0k^1";
char operadores[100];
pExpressao x;
